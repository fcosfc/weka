...
END {
  print DISTINCT_ATTRIBUTES, BRANCHES_NUMBER, LEAVES_NUMBER, INSTANCES, SECONDS_TO_BUILD_MODEL, CORRECTLY_CLASSIFIED_INSTANCES_PERCENTAJE, INCORRECTLY_CLASSIFIED_INSTANCES_PERCENTAJE, KAPPA_STATISTIC, MAE, RMSE, RAE, RRSE
}
