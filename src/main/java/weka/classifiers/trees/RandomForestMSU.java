 ...
 * @version $Revision$
 */
public class RandomForestMSU extends Bagging {
  ...
  public String numFeaturesTipText() {
    return ((RandomTreeMSU) getClassifier()).KValueTipText();
  }
  ...
  public int getNumFeatures() {
    ...
    return ((RandomTreeMSU) getClassifier()).getKValue();
  }
  ...
  public void setNumFeatures(int newNumFeatures) {
    ...
    ((RandomTreeMSU) getClassifier()).setKValue(newNumFeatures);
  }
  ...
  public void setComputeAttributeImportance(boolean computeAttributeImportance) {
    ...
    ((RandomTreeMSU)m_Classifier).setComputeImpurityDecreases(computeAttributeImportance);
  }
  ...
  public String maxDepthTipText() {
    return ((RandomTreeMSU) getClassifier()).maxDepthTipText();
  }
  ...
  public int getMaxDepth() {
    return ((RandomTreeMSU) getClassifier()).getMaxDepth();
  }
  ...
  public void setMaxDepth(int value) {
    ((RandomTreeMSU) getClassifier()).setMaxDepth(value);
  }
  ...
  public String breakTiesRandomlyTipText() {
    return ((RandomTreeMSU) getClassifier()).breakTiesRandomlyTipText();
  }
  ...
  public boolean getBreakTiesRandomly() {
    ...
    return ((RandomTreeMSU) getClassifier()).getBreakTiesRandomly();
  }
  ...
  public void setBreakTiesRandomly(boolean newBreakTiesRandomly) {
    ...
    ((RandomTreeMSU) getClassifier()).setBreakTiesRandomly(newBreakTiesRandomly);
  }
  ...
  public void setDebug(boolean debug) {
    ...
    ((RandomTreeMSU) getClassifier()).setDebug(debug);
  }
  ...
  public void setNumDecimalPlaces(int num) {
    ...
    ((RandomTreeMSU) getClassifier()).setNumDecimalPlaces(num);
  }
  ...
  public void setBatchSize(String size) {
    ...
    ((RandomTreeMSU) getClassifier()).setBatchSize(size);
  }
  ...
  public void setSeed(int s) {
    ...
    super.setSeed(s);
    ((RandomTreeMSU) getClassifier()).setSeed(s);
  }
  ...
  public double[] computeAverageImpurityDecreasePerAttribute(
    ...
    for (Classifier c : m_Classifiers) {
      double[][] forClassifier = ((RandomTreeMSU) c).getImpurityDecreases();
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    RandomTreeMSU classifier =
      ((RandomTreeMSU) AbstractClassifier.forName(defaultClassifierString(),
        options));
